...
const Collection = ({
  ...
  return (
    <div
      id={id}
      key={id}
      className="flex gap-3 items-center p-4 bg-white rounded-xl border shadow-sm transition-all duration-200 group border-neutral-200 hover:shadow-md hover:border-neutral-300"
    >
      <input
        checked={isSelected}
        type="checkbox"
      ...
      />{" "}
      <Link
        className="py-2 font-medium text-gray-700 transition-colors grow hover:text-blue-600"
