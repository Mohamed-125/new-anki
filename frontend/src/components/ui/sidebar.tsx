...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="relative group peer text-sidebar-foreground md:block"
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "absolute inset-y-0 z-10   h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeft className="w-5 h-5 text-lg text-black" />
